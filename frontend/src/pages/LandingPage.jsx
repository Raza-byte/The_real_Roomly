    ...
    return (
        <div className="min-h-screen bg-cream-50 flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-8 text-center animate-fade-in">
                <p className="font-body text-sand-400 text-sm tracking-widest uppercase mb-4">Interior Design Studio</p>
                ...
                <p className="font-body text-sand-400 text-lg max-w-xl mb-10">
            ...
            <footer className="px-8 py-5 border-t border-cream-200 text-center">
                <p className="font-body text-xs text-sand-400">Spacify — Sprint 1 Build · Interior Design App</p>
            </footer>
        </div>
    );
};
